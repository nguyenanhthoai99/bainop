                ...
                <div class="row nbat ">
                    ...
                    <?php foreach ($data as $item) : ?>
                        ...
                        <div class="col-md-3 col-xs-12 main-dt-nbat ">
                            <a href="sanphamdienthoai.php?item=<?= $item['sp_ma'] ?>"><img src="/nguyenanhthoai/fontend/images/dienthoai/<?= $item['sp_hinh']; ?> " class="hinh-dt-nbat img-fluid mt-3 " style="height: 200px; width:200px; padding-left:10px;" onmouseenter="increaseSize(this) " onmouseout="decreaseSize(this) ">
                                <div class="card-body ">
