                ...
                <div class="row nbat ">
                    ...
                    <?php foreach ($data as $item) : ?>
                        ...
                        <div class="col-md-3 col-xs-12 main-dt-nbat ">
                            <a href="sanphamlaptop.php?item=<?= $item['sp_ma'] ?>"><img src="/nguyenanhthoai/fontend/images/laptop/<?= $item['sp_hinh']; ?> " class="hinh-dt-nbat img-fluid mt-3 " onmouseenter="increaseSize(this) " onmouseout="decreaseSize(this) ">
                                <div class="card-body ">
